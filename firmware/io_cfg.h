...
#define SPISS					REGISTER_BIT(PORTB,2)
#define M1		  				REGISTER_BIT(PORTB,1)
#define M2		  				REGISTER_BIT(PORTB,0)
#define M3		  				REGISTER_BIT(PORTD,7)
#define M4		  				REGISTER_BIT(PORTD,6)
#define M5		  				REGISTER_BIT(PORTD,6)
#define M6		  				REGISTER_BIT(PORTD,5)
#define M1_DIR 					REGISTER_BIT(DDRB,1)
#define M2_DIR 					REGISTER_BIT(DDRB,0)
#define M3_DIR 					REGISTER_BIT(DDRD,7)
#define M4_DIR 					REGISTER_BIT(DDRD,6)
